...
type RegisterResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UseId         int64                  `protobuf:"varint,1,opt,name=use_id,json=useId,proto3" json:"use_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RegisterResponse) GetUseId() int64 {
	if x != nil {
		return x.UseId
	}
	return 0
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x06use_id\x18\x01 \x01(\x03R\x05useId\"W\n" +
	...
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponseB\x12Z\x10sso.sso.v1;ssov1b\x06proto3"
